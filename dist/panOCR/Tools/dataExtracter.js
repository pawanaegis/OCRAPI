const getPan = (text) => {
    for (let i = 0; i < text.length; i++) {
        if (containsInteger(text[i]) && containsCharacter(text[i]))
            return text[i];
    }
    return "not found!";
};
...
export { getPan, getDob, getGender, getName, getAdharno, getAddress, dlFatherName, getDLNum, getDLname, getDLValidity, getDLdob, };
//# sourceMappingURL=dataExtracter.js.map